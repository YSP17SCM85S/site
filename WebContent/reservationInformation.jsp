  ...
  <div class="logmod__wrapper">
	...
	<section id="slider"><!--slider-->
		...
		<div class="col-sm-3">
				...
				RentalBean rentBean =   (RentalBean) session.getAttribute("showRent");
					%>				
				<form>
				<center>
				<table width=600 px>
						<tr><td><strong style="color : red">Congratulations !!!! Your ride has been booked here are the details</strong></td></tr>
						<tr width=600px><td>RESERVATION ID</td><td><strong>RCTEAM4<%=rentBean.getRentID()%><strong></td></tr>
						<tr><td>CUSTOMER ID</td><td><%=rentBean.getCustomerID() %></td></tr>
						<tr><td>FROM</td><td><%=rentBean.getStartDt()%></td></tr><tr><td>TO</td><td><%=rentBean.getEndDt()%></td></tr>						
						<tr><td>CAR BOOKED</td><td><%=rentBean.getCarName()%></td></tr>
						<tr><td>CAR REG. NO.</td><td><%=rentBean.getRegitrationNUMBER()%></td></tr>
						<tr><td>TARRIF FOR THE RIDE</td><td>$<%=rentBean.getTarrif()%></td></tr>
				</table>
				</center>
				</form>
