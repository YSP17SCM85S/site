  ...
  <div class="logmod__wrapper">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.jsp"><img src="images/home/logoo.png" alt="" height="130" width="130" /></a>
						</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="search-header " style="background-color:#55B9EB">
					      	<h2 style="color:white"><center>Write Your Reviews !!!</center></h2>     
					<form>
	...
	<section id="slider"><!--slider-->
		...
		<div class="col-sm-3">
			...
			bean =  (CarBean)session.getAttribute("forReviews");
            
			
			
			
			%>
			<form method="get" action="writereview.jsp">
					<center> <table width="700px" cellpadding="10">
						<tr width ="700px" >
						<td><strong> Car name</strong> <center></td>
						<td><strong> <input  type="text" size="20" name="carname" readonly value=<%=bean.getBrand() %> <%=bean.getCarNAME() %>  ></input></strong> </td>
						</tr>
						<tr>
						<td> Model number <center></td>
						<td> <input type="text" size="20" name="modelnumber" readonly value="<%=bean.getModel() %>"></input> </td>
						</tr>


						<tr>
						<td> Registration number <center></td>
						<td> <input type="text" size="20" name="registrationnumber" readonly value=<%=bean.getRegistrationNUMBER() %> ></input> </td>
						</tr>
						
						<tr >
						<td> Rent <center></td>
						<td> <input type="text" size="20" name="rent" ></input> </td>
						</tr>
						
						<tr>
						<td> Username <center></td>
						<td> <input type="text" size="20" name="username"  ></input> </td>
						</tr>
						<tr>
						<td> Gender <center></td>
						<td> <input type="radio" name="gender" value = "male" ></input> Male
		                     <input type="radio" name="gender" value = "female" ></input>Female </td>
						</tr>
						<tr>
						<td> Occupation <center></td>
						<td> <input type="text" size="20" name="occupation" ></input> </td>
						</tr>
						<tr>
						<td> User age <center></td>
						<td> <input type="text" size="2" name="userage" ></input> </td>
						</tr>
						<tr>
						<td> Ratings <center></td>
						<td> <input type="radio" name="rating" value = "1" ></input> 1
							 ...
							 <input type="radio" name="rating" value = "5" ></input>5
		                 
					    </td>
						</tr>
						<tr>
						<td> Review <center></td>
						<td> <textarea name="review", rows=4, cols=50 style="border:solid 1px black; background-color: white;"  ></textarea> </td>
						</tr>
						<tr>
						<td></td>
						<td>
