		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<div class="search-header" style="background-color:#55B9EB;text-align:center; verticle-align: middle">
					      	     
						<form  >
						<table cellpadding="20" style="width: 100%" >
						<tr height=80px>
							<h2 style="color:white" >Please Provide the Billing Information</h2>
						</tr>
		...
		<div class="col-sm-3">			
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Electronic Check</a>
   ...
   <center> <div class="row">
        ...
        <div class="">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <center><label>       </label><label for="cardNumber">
                               CARD NUMBER</label></center>
                        <div class="input-group">
                            <input type="text" class="form-control" id="cardNumber" placeholder="Valid Card Number" name="creditCardNumber"
                                required autofocus />
          ...
          <div class="control-group">
            <center><label class="control-label"  for="username">CARD HOLDER'S NAME</label></center>
            <div class="controls">
                 <input type="text" class="form-control" id="cardNumber" name="cardHolderName" placeholder=""
                                required  />
								<br/>
								<br/>
								<div class="col-sm-3">
						...
						<div class="form-group">
                                ...
                                <textarea rows="4" cols="50" name="billingAddress" class="form-control"  id="billingAddress" placeholder="Billing Address"  required ></textarea>
                            </div>
            ...
            <br/>
            <input type="submit"  class="btn btn-success btn-lg btn-block" role="button" value="PAY" ></input>
