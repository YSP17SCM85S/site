			...
			<div class="container">
				<div class="row">
					...
					<br>
					 ...
					 <% String carname = request.getParameter("carname").trim();
	                    String rent =     request.getParameter("rent").trim();
       	                String modelnumber   = request.getParameter("modelnumber").trim();
						...
						MongoDBDataUtilities.insertReviews(carname,rent,modelnumber,registrationnumber,username,gender,occupation,userage,rating,review,reviewdate);
					...
					<div class="search-header " style="background-color:#55B9EB">
					      	<h2 style="color:white"><center>Feedback submiited successfully</center></h2>     
						<form  >
