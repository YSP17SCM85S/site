			...
			<div class="container">
				<div class="row">
					...
					<div class="search-header " style="background-color:#55B9EB">
					      	<h2 style="color:white"><center>Most Reviewed Cars</center></h2>     
						<form  >
					...
					<center> <table border = "1" cellpadding='2' cellspacing='1'>
						 <tr>
						 <td><strong> Product name  </strong></td> <td><strong> Number of Reviews</strong></td>
						 </tr>
							<% 
							MongoDBDataUtilities dataUtilities = new MongoDBDataUtilities();
							   ArrayList <Bestrating> Bestrate = new ArrayList <Bestrating> ();
							  Bestrate =  dataUtilities.topProducts();
							  for(Bestrating best : Bestrate){%>
								  
								  <tr>
								 
								  <td><%out.println(best.getProductname());%> </td>
								  <td><%out.println(best.getRating());%> </td>
								  <tr>
							 ...
							 <% }
                               ...
                               System.out.println(Bestrate.size());
							  %>
						</table>
