...
<div class="container">
  ...
  <div class="logmod__wrapper">
	...
	<h2><center>Please Provide the Information</center></h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<table>
					<tr><td>Credit Card Number</td><td><input type="text"></td></tr>
					<tr><td>Expiry Date</td><td><input type="text"></td></tr>
					<tr><td>Billing Address</td><td><textarea name="billingAddress"></textarea></td></tr>
					<tr><td></td><td><input type="submit" value="Pay Now"></td></tr>	
					</table>
					</form>		
					</div>
