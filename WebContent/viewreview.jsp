...
<%@ page import="dao.MongoDBDataUtilities"%>
<%@ page import="java.util.*"%>
<%@ page import="java.io.*,java.util.*,java.util.Date,java.text.*" %>
			...
			<div class="container">
				<div class="row">
					...
					<div class="search-header " style="background-color:#55B9EB">
					      	<h2 style="color:white"><center>Reviews</center></h2>     
						<form  >
						...
						String carname = bean.getBrand()+" "+bean.getCarNAME();
						
	                    
						MongoDBDataUtilities data = new MongoDBDataUtilities();
	                   	Reviewmap = data.Viewreview(carname);%>
						
						
					
						<%Iterator<Map.Entry<String, ArrayList<Review>>> itr = Reviewmap.entrySet().iterator() ;
						while(itr.hasNext()){
							Map.Entry<String, ArrayList<Review>> revi  = itr.next();
							                  reviews = (ArrayList)revi.getValue(); 
                                               for(Review rev :reviews){%>
											  <center> <table border = "1" cellpadding='2' cellspacing='1'>
											  <h2> </h2><br />
												   <tr>
												   <td><strong>Carname      		 : </strong></td>
												   <td><strong><%out.println(rev.getCarname());%></strong>
												   </tr>
												   
												   <tr>
												   <td>Rent          		 : </td>
												   <td><%out.println(rev.getRent());%>
												   </tr>
												   
												   <tr>
												   <td>Model-Number  		 : </td>
												   <td><%out.println(rev.getModelnumber());%>
												   </tr>
												   
												   <tr>
												   <td>Registration-Number   : </td>
												   <td><%out.println(rev.getRegistrationnumber());%>
												   </tr>
												   
												   <tr>
												   <td>User-name             : </td>
												   <td><%out.println(rev.getUsername());%>
												   </tr>
												   
												   <tr>
												   <td>User-age 			 : </td>
												   <td><%out.println(rev.getUserage());%>
												   </tr>
												   
												   <tr>
												   <td>Occupation 			 : </td>
												   <td><%out.println(rev.getOccupation());%>
												   </tr>
												   
												   <tr>
												   <td>Gender  				 : </td>
												   <td><%out.println(rev.getGender());%>
												   </tr>
												   
												   <tr>
												   <td>Review-date			 : </td>
												   <td><%out.println(rev.getReviewdate());%>
												   </tr>
												  <tr>
												   <td>Rating				 : </td>
												   <td><%out.println(rev.getRating());%>
												   </tr>
												   
												   <tr>
												 
												   <td>Review				 : </td>
												   <td><%out.println(rev.getReview());%>
												   </tr>
												   </table></center>
